...
function minifyViewportNumber(value) {
...
function minifyMetaViewportValue(value) {
...
function isMetaViewport(attrs, tagName) {
...
function normalizeOptions(moduleOptions) {
    if (moduleOptions && typeof moduleOptions === 'object') {
        ...
        } else if (moduleOptions.redundantWhitespaces === 'safe' || moduleOptions.redundantWhitespaces === 'aggressive' || moduleOptions.redundantWhitespaces === false) {
