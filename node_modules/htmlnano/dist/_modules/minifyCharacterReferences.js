...
function isDecodableCodePoint(codePoint) {
...
function resolveReference(reference, decodeAll) {
...
function decodeReferences(text, inAttribute, decodeAll) {
    if (text.indexOf('&') === -1) {
        return text;
    }
...
const mod = {
    onContent (_options, moduleOptions) {
        const decodeAll = (moduleOptions == null ? void 0 : moduleOptions.decodeAll) === true;
        return (content, node)=>{
    ...
    onAttrs (_options, moduleOptions) {
        ...
        return (attrs)=>{
            ...
            for (const [name, value] of Object.entries(attrs)){
                newAttrs[name] = typeof value === 'string' ? decodeReferences(value, true, decodeAll) : value;
            }
            return newAttrs;
        };
    }
