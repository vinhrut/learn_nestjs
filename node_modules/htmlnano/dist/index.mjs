...
const modules = {
    ...
    minifyCharacterReferences: ()=>interop(import('./_modules/minifyCharacterReferences.mjs')),
    ...
    normalizeDoctype: ()=>interop(import('./_modules/normalizeDoctype.mjs')),
    ...
    removeXmlLeftovers: ()=>interop(import('./_modules/removeXmlLeftovers.mjs')),
...
const htmlnano = Object.assign(function htmlnano(optionsRun = {}, presetRun) {
    ...
    const minifier = async (_tree)=>{
        ...
        for (const [moduleName, moduleOptions] of Object.entries(options)){
            ...
            const typedModuleOptions = moduleOptions;
